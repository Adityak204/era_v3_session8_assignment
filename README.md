...
## Layer-wise Details
```
| Layer              | Input Size    | Kernel Size | Padding | Dilation | Stride | Output Size    | Jump | Receptive Field |
|---------------------|---------------|-------------|---------|----------|--------|----------------|------|-----------------|
| **Input**          | 32 × 32 × 3   | -           | -       | -        | -      | 32 × 32 × 3    | 1    | 1               |
| **Conv2d (16)**    | 32 × 32 × 3   | 3 × 3       | 1       | 1        | 1      | 32 × 32 × 16   | 1    | 3               |
| **Conv2d (32)**    | 32 × 32 × 16  | 3 × 3       | 1       | 1        | 1      | 32 × 32 × 32   | 1    | 5               |
| **Conv2d (64)**    | 32 × 32 × 32  | 3 × 3       | 1       | 1        | 1      | 32 × 32 × 64   | 1    | 7               |
| **Transition-1**   | 32 × 32 × 64  | 1 × 1       | 0       | 1        | 1      | 32 × 32 × 16   | 1    | 7               |
| **Conv2d (32)**    | 32 × 32 × 16  | 3 × 3       | 1       | 1        | 1      | 32 × 32 × 32   | 1    | 9               |
| **Conv2d (32)**    | 32 × 32 × 32  | 3 × 3       | 1       | 1        | 1      | 32 × 32 × 32   | 1    | 11              |
| **Conv2d (64)**    | 32 × 32 × 32  | 3 × 3       | 1       | 2        | 2      | 16 × 16 × 64   | 2    | 13              |
| **Transition-2**   | 16 × 16 × 64  | 1 × 1       | 0       | 1        | 1      | 16 × 16 × 16   | 2    | 13              |
| **Conv2d (32)**    | 16 × 16 × 16  | 3 × 3       | 1       | 1        | 1      | 16 × 16 × 32   | 2    | 17              |
| **Conv2d (32)**    | 16 × 16 × 32  | 3 × 3       | 1       | 1        | 1      | 16 × 16 × 32   | 2    | 21              |
| **Conv2d (64)**    | 16 × 16 × 32  | 3 × 3       | 1       | 3        | 2      | 8 × 8 × 64     | 4    | 25              |
| **Transition-3**   | 8 × 8 × 64    | 1 × 1       | 0       | 1        | 1      | 8 × 8 × 16     | 4    | 25              |
| **Conv2d (32)**    | 8 × 8 × 16    | 3 × 3       | 1       | 1        | 1      | 8 × 8 × 32     | 4    | 33              |
| **Conv2d (32)**    | 8 × 8 × 32    | 3 × 3       | 1       | 1        | 1      | 8 × 8 × 32     | 4    | 41              |
| **Depthwise (128)**| 8 × 8 × 32    | 3 × 3       | 1       | 1        | 1      | 8 × 8 × 128    | 4    | 49              |
| **GAP**            | 8 × 8 × 128   | 8 × 8       | 0       | -        | -      | 1 × 1 × 128    | -    |                 |
| **FC**             | 1 × 1 × 128   | -           | -       | -        | -      | 1 × 1 × 10     | -    |
